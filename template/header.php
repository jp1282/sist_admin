...
<div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <li class="nav-item active"><a class="nav-link" href="login.php">Acceso Admin</a></li>
        <li class="nav-item active"><a class="nav-link" href="login_clientes.php">Acceso Clientes</a></li>
